...
class Report:
    ...
    def run324(self):
        TaiKhoan324 = pd.read_excel(
            ...
            skiprows=8,
            skipfooter=1,
            names=['SoTaiKhoan', 'TenKhachHang', 'DuDauNoBravo', 'DuDauCoBravo', 'PhatSinhGiamBravo',
                   'PhatSinhTangBravo', 'DuCuoiNoBravo', 'DuCuoiCoBravo'],
        )
    ...
    def run1231(self):
        TaiKhoan1231 = pd.read_excel(
            ...
            skiprows=8,
            skipfooter=1,
            names=['SoTaiKhoan', 'TenKhachHangBravo', 'DuDauNoBravo', 'DuDauCoBravo', 'PhatSinhNoBravo',
        ...
        worksheet.write_row('C11', ['Dư nợ đầu', 'Dư có đầu', 'Ps nợ', 'Ps có', 'Dư nợ cuối', 'Dư có cuối'],
